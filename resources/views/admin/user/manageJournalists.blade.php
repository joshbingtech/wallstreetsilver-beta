                    ...
                    @foreach ($journalists as $journalist)
                        <tr data-journalist_id="{{ $journalist['id'] }}">
                            ...
                            @if($journalist->trashed())
                                ...
                                <td class="text-center">
                                    <a href="#" class="unlock-btn icon-action" title="Unlock journalist"><i class="fa-solid fa-unlock"></i></a>
                            ...
                            @else
                                ...
                                <td class="text-center"> {{ $journalist['created_at'] }} </td>
                                <td class="text-center">
                                    <a href="#" class="lock-btn icon-action" title="Lock journalist"><i class="fa-solid fa-lock"></i></a>
                                    <div class="dot-opacity-loader" style="display: none;">
                                        <span></span>
                                        <span></span>
                                        <span></span>
